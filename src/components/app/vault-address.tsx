...
export function VaultAddress({ address, className, cluster = "devnet" }: VaultAddressProps) {
  ...
  return (
    <div className={cn("rounded-xl border border-neutral-100 bg-white p-4 shadow-soft", className)}>
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div>
          <p className="text-[11px] font-medium uppercase tracking-wider text-neutral-400">Vault address</p>
